export const quinceMainData = {
  ...
  event: {
    celebrant: "Nicole Andrea",
    //Padres María de Jesús Gutiérrez y Andres Ramírez
    parents: {
      father: "Miriam Gómez Trasviña",
      mother: "Alejandro Chinchillas Alvarez",
    ...
    images: [
      {
        ...
        alt: "Nicole Andrea en sus XV años",
        caption: "Nicole Andrea radiante en su día especial.",
      },
      {
        id: "image2",
        src: "/images/rapunzel2.jpeg",
        alt: "Baile de Quinceañera",
        caption: "El emotivo primer baile de Nicole Andrea.",
      },
      {
        id: "image3",
      ...
      },
      {
        ...
        caption: "Nicole Andrea rodeada de sus seres queridos.",
      },
      {
        id: "image5",
      ...
      },
      {
        ...
        alt: "Nicole Andrea y sus Padres",
  ...
  customInvitations:{
    ...
    invitationUrl: "https://quince-vip-Nicole Andrea.vercel.app/",
    suggested_messages: [
